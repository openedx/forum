...
class MySQLBackend(AbstractBackend):
    ...
    def update_stats_for_course(
        ...
        CourseStat.update_stats_for_user_and_course(user_id, course_id, **kwargs)
    ...
    def get_user(user_id: str) -> dict[str, Any] | None:
        ...
        forum_user = ForumUser.get_by_user_id(user_id)
        return forum_user.to_dict() if forum_user else None
    ...
    def get_user_by_username(username: str | None) -> dict[str, Any] | None:
        ...
        if not username:
            return None
        forum_user = ForumUser.get_by_username(username)
        return forum_user.to_dict() if forum_user else None
    ...
    def delete_comments_of_a_thread(thread_id: str) -> None:
        ...
        Comment.delete_by_thread_id(thread_id)
    ...
    def user_to_hash(
        ...
        return ForumUser.user_to_hash(
            user_id,
            params,
            filter_standalone_threads=cls.filter_standalone_threads,
            find_subscribed_threads=cls.find_subscribed_threads,
            get_user_voted_ids=cls.get_user_voted_ids,
        )
    ...
    def unsubscribe_all(user_id: str) -> None:
        ...
        ForumUser.unsubscribe_all(user_id)

    @staticmethod
    def retire_all_content(user_id: str) -> None:
        """Retire all content from user."""
        ForumUser.retire_all_content(user_id)
    ...
    def find_or_create_user(
        ...
        """Find or create user."""
        forum_user = ForumUser.find_or_create_user(user_id, username, default_sort_key)
    ...
    def get_user(user_id: str) -> dict[str, Any] | None:
        """Return user from user_id."""
        return ForumUser.get_by_user_id(user_id)

    @staticmethod
    def get_thread(thread_id: str) -> dict[str, Any] | None:
        """Return thread from thread_id."""
        return CommentThread.get_by_id(thread_id)
    ...
    def delete_thread(thread_id: str) -> int:
        ...
        return CommentThread.delete_by_id(thread_id)

    @staticmethod
    def create_thread(data: dict[str, Any]) -> str:
        """Create thread."""
        return CommentThread.create_from_data(data)
    ...
    def update_thread(
        ...
        **kwargs: Any,
        ...
        return CommentThread.update_by_id(thread_id, **kwargs)
    ...
    def get_filtered_threads(query: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        return CommentThread.get_filtered_by_query(query)

    @staticmethod
    def update_user(user_id: str, data: dict[str, Any]) -> int:
        """Update user info and ForumUser fields."""
    ...
    def get_course_id_by_thread_id(thread_id: str) -> str | None:
        ...
        """
        return CommentThread.get_course_id_by_id(thread_id)
    ...
    def get_paginated_user_stats(
        ...
        return ForumUser.get_paginated_user_stats(
